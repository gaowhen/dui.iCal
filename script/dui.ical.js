/**
 * Author: Miko Gao gaocheng@douban.com
 *
 */
(function(){
    var dui = window.dui || {};
        ...
        function _initCal(option) {
            ...
            switch (opt.type) {
                ...
                case 'popup':
                    ...
                    $('#dui-ical-templ').tmpl(data).appendTo('body').show();
                    ...
                    $(document).unbind('click.closeiCal').bind('click.closeiCal', function(e) {
                        var $this = $(e.target);
                        var isCal = $this.parents('div.dui-ical').length;
                    ...
                    // normal
                default:
                    $('#dui-ical-templ').tmpl(data).appendTo(opt.ele).show();
                    var $iCal = $('#' + opt.context);
            }
